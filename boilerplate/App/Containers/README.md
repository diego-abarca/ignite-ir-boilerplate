...
Also located in here are 2 special containers: `App.js` and `RootScreen.js`.
...
`RootScreen.js` is the first visual component in the app.  It is the ancestor of all other screens and components.
